...
**技术目标**  
在 `apps/license-worker/`（Cloudflare Worker + D1）实现 5 个端点，与 Python 版签名协议对齐。
...
**涉及文件**
- `apps/license-worker/src/*`
- `apps/license-worker/wrangler.toml`
- `apps/license-worker/migrations/*.sql`

...
LICENSE_PROTOCOL_VERSION = 3
LICENSE_LEASE_RENEWAL_HOURS = 24
LICENSE_LEASE_HARD_EXPIRY_HOURS = 72
LICENSE_RUNTIME_GRANT_MINUTES = 30
LICENSE_REQUIRE_ONLINE_FOR_TASKS = True
LICENSE_PUBLIC_KEY = "H0KTidHIXV0nvzkUNmssrx5t5IrUvEQi1WVelkuCJm8"
INTEGRITY_MANIFEST_FILE_NAME = "integrity_manifest.json"
# 默认复用授权验签公钥；生产环境可切换为独立 manifest 公钥。
INTEGRITY_MANIFEST_PUBLIC_KEY = LICENSE_PUBLIC_KEY
SECURITY_CORE_LIBRARY_BASENAME = "security_core"
LICENSE_TASK_REVIEW_FIND = "review_find"
LICENSE_TASK_REVIEW_FULL_SCAN = "review_full_scan"
LICENSE_TASK_QUALITY_REFUND = "quality_refund"
LICENSE_TASK_BATCH_DELIVERY = "batch_delivery"
LICENSE_TASK_CACHE_MANAGE = "cache_manage"
LICENSE_TASK_POLICY = (
